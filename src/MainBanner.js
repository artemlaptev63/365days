  ...
  render() {
    ...
    return (
      <div>
          ...
          <div className="container">
            <div className="grid-item about-image">
              <span className="title">
                Photo by&nbsp;
                <Link to={`/detail/${lastItem.id}`}>{lastItem.autor}</Link>
                <i>{lastItem.mainBannerTitle}</i>
              </span>
            </div>
          </div>
          <div className="grid-row-2">
            ...
            <div className="grid-item desc">
              <p className="description">
                <i>Three Sixty Five Creative</i> is an online magazine
                <br /> featuring one talented contemporary photographer a day.
                <br /> Discover and get inspired.
              </p>
            </div>
          </div>
        </div>
        <div id="welcome">
          <h1>
            Want to suggest a <i>photographer</i>?
          </h1>
          <p>
            Send an email to{" "}
            <a href="mailto:hello.legendaryphotographers@gmail.com">
              <i>365creativephotography@gmail.com</i>
            </a>
          </p>
